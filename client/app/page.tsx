...
const services = [
  ...
  },
  {
    ...
    href: "/#contact",
    desc: "Expert architectural design, quantity surveying and project management for residential and commercial builds.",
  },
  {
    icon: Calculator,
    ...
    <>
      ...
      <section className="border-t border-border bg-[oklch(0.97_0.005_80)] py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-8">
            {/* Equity Bank */}
            <div className="group flex min-w-[220px] flex-col items-center gap-4 rounded-2xl border border-border bg-white px-10 py-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:shadow-md">
              <div
                className="flex h-20 w-20 items-center justify-center rounded-2xl shadow-inner"
              ...
              <div className="text-center">
                ...
                <p className="mt-1 text-xs text-slate-500">Rwanda</p>
                <span
                  className="mt-2 inline-block rounded-full px-2.5 py-1 text-[10px] font-bold"
                  style={{
                    backgroundColor: "#D31145" + "18",
                    color: "#D31145",
                  }}
                >
                  Financial Partner
            ...
            <div className="group flex min-w-[220px] flex-col items-center gap-4 rounded-2xl border-2 border-dashed border-slate-300 bg-white px-10 py-8 transition-colors duration-300 hover:border-[oklch(0.42_0.19_25)]">
              <div className="flex h-20 w-20 items-center justify-center rounded-2xl bg-slate-100 transition-colors group-hover:bg-[oklch(0.42_0.19_25)]/10">
                <svg
                  width="36"
                  height="36"
                  viewBox="0 0 24 24"
                  fill="none"
                  stroke="currentColor"
                  className="text-slate-400 transition-colors group-hover:text-[oklch(0.42_0.19_25)]"
                  strokeWidth="1.5"
                  strokeLinecap="round"
              ...
              <div className="text-center">
                <p className="text-sm font-bold text-slate-600 transition-colors group-hover:text-[oklch(0.42_0.19_25)]">
                  Become a Partner
                </p>
                <p className="mt-1 text-xs text-slate-400">Join our network</p>
                <a
                  href="mailto:kosresltd@gmail.com"
                  className="mt-2 inline-block rounded-full bg-[oklch(0.42_0.19_25)]/10 px-2.5 py-1 text-[10px] font-bold text-[oklch(0.42_0.19_25)]"
                >
                  Contact us →
                </a>
              </div>
          ...
          <p className="mt-10 text-center text-xs text-slate-400">
            ...
            <a
              href="mailto:kosresltd@gmail.com"
              className="font-semibold text-[oklch(0.42_0.19_25)] hover:underline"
            >
              Get in touch
            </a>
          </p>
      ...
      <section className="bg-white py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
            ...
            {/* Instagram */}
            <a
              href="https://instagram.com/kosresltd"
              target="_blank"
              rel="noopener noreferrer"
            ...
            {/* Facebook */}
            <a
              href="https://facebook.com/kosresltd"
              target="_blank"
              rel="noopener noreferrer"
            ...
            {/* TikTok */}
            <a
              href="https://tiktok.com/@kosresltd"
              target="_blank"
              rel="noopener noreferrer"
            ...
            {/* YouTube */}
            <a
              href="https://youtube.com/@kosresltd"
              target="_blank"
              rel="noopener noreferrer"
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          {/* 4-card grid: WhatsApp · Email · Office · Hours */}
          <div className="grid gap-5 text-center sm:grid-cols-2 lg:grid-cols-4">
            {/* WhatsApp */}
            <a
              href="https://wa.me/250792871729?text=Hello%20KOSRES%2C%20I%27d%20like%20to%20book%20a%20consultation."
              target="_blank"
              rel="noopener noreferrer"
