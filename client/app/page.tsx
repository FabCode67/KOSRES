...
export default function HomePage() {
  return (
    <>
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-4 py-20 sm:px-6">
          <div className="animate-fade-up max-w-2xl">
            <p className="mb-4 text-sm font-semibold tracking-[0.2em] text-amber-300 uppercase">
              Kigali One Stop Real Estate Service
            </p>
            ...
            <p className="mb-8 text-lg leading-relaxed text-white/80">
              ...
              manage and value real estate across Rwanda. All services under one
              roof.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="mb-12 text-center">
            ...
            <p className="mx-auto mt-3 max-w-xl text-sm text-muted-foreground">
              ...
              Institute of Real Property Valuers in Rwanda — delivering
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {services.map(({ icon: Icon, title, desc }) => (
              <div
                key={title}
                className="card-hover flex flex-col gap-3 rounded-xl border border-border bg-white p-5"
              >
      ...
      <section
        id="about"
        className="mx-auto grid max-w-7xl items-center gap-12 px-4 py-20 sm:px-6 md:grid-cols-2"
      >
        ...
        <div>
          ...
          <p className="mb-4 text-sm leading-relaxed text-muted-foreground">
            KOSRES LTD is a professional real estate consulting firm regulated
            by the Rwanda Development Board and the Institute of Real Property
            Valuers in Rwanda. We pride ourselves on delivering excellent
          ...
          <div className="mt-6 grid grid-cols-2 gap-4">
            {[
              ...
              >
                <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[oklch(0.42_0.19_25)] text-xs font-bold text-white">
                  {v.icon}
                </span>
                {v.label}
              </div>
          ...
          <div className="mt-6 rounded-xl border border-border bg-muted p-4">
            <p className="text-xs text-muted-foreground italic">
              "To be one of the best real estate service providers across Africa
              — delivering reliable and innovative services powered by
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className="grid gap-6 text-center sm:grid-cols-3">
            <a
              href="https://wa.me/250786684390?text=Hello%20KOSRES%2C%20I%27d%20like%20to%20book%20a%20consultation."
              target="_blank"
            ...
            >
              ...
              <p className="text-sm text-white/80">+250 786 684 390</p>
            </a>
            <a
      ...
      {/* ── FOOTER ── */}
      <footer className="bg-[oklch(0.08_0.01_250)] py-6 text-center text-xs text-white/50">
        © {new Date().getFullYear()} KOSRES LTD · Kigali One Stop Real Estate
        Service · "All Services Under One Roof"
      </footer>
    </>
  )
}
