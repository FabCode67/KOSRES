        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className="mx-auto grid max-w-5xl grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-6">
            ...
            <a href="https://wa.me/250792871729" target="_blank" rel="noopener noreferrer"
              ...
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl shadow-md transition-transform duration-300 group-hover:scale-110" style={{ backgroundColor: "#25D366" }}>
              ...
              <div className="text-center">
                ...
                <p className="mt-0.5 text-[10px] text-slate-500">+250 792 871 729</p>
                <p className="mt-1 text-[10px] font-semibold" style={{ color: "#25D366" }}>Chat →</p>
              </div>
            </a>

            {/* Instagram */}
            <a href="https://www.instagram.com/kosres2026?igsh=MTNyMGY0dDVpamdlZA==" target="_blank" rel="noopener noreferrer"
              ...
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl shadow-md transition-transform duration-300 group-hover:scale-110"
              ...
              <div className="text-center">
                ...
                <p className="mt-1 text-[10px] font-semibold" style={{ color: "#E1306C" }}>Follow →</p>
              </div>
            </a>

            {/* Facebook */}
            <a href="https://www.facebook.com/share/1Ng4AZUsex/" target="_blank" rel="noopener noreferrer"
              ...
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl shadow-md transition-transform duration-300 group-hover:scale-110" style={{ backgroundColor: "#1877F2" }}>
              ...
              <div className="text-center">
                ...
                <p className="mt-1 text-[10px] font-semibold" style={{ color: "#1877F2" }}>Like →</p>
              </div>
            </a>

            {/* TikTok */}
            <a href="https://www.tiktok.com/@kigali.one.stop.r" target="_blank" rel="noopener noreferrer"
              ...
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl shadow-md transition-transform duration-300 group-hover:scale-110" style={{ backgroundColor: "#010101" }}>
              ...
              <div className="text-center">
                ...
                <p className="mt-0.5 text-[10px] text-slate-500">@kigali.one.stop.r</p>
                <p className="mt-1 text-[10px] font-semibold text-slate-700">Follow →</p>
              </div>
            </a>

            {/* YouTube */}
            <a href="https://youtube.com/@kigalionestoprealestateservice?si=OoB431_iEcjpPbCL" target="_blank" rel="noopener noreferrer"
              ...
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl shadow-md transition-transform duration-300 group-hover:scale-110" style={{ backgroundColor: "#FF0000" }}>
              ...
              <div className="text-center">
                ...
                <p className="mt-0.5 text-[10px] text-slate-500">@kigalionestop</p>
                <p className="mt-1 text-[10px] font-semibold" style={{ color: "#FF0000" }}>Subscribe →</p>
              </div>
            </a>

            {/* X / Twitter */}
            <a href="https://x.com/KOSRESLTD" target="_blank" rel="noopener noreferrer"
              ...
              <div className="flex h-12 w-12 items-center justify-center rounded-2xl shadow-md transition-transform duration-300 group-hover:scale-110" style={{ backgroundColor: "#000000" }}>
                <svg width="20" height="20" viewBox="0 0 24 24" fill="white"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.253 5.622 5.911-5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </div>
              <div className="text-center">
      ...
      <footer className="bg-[oklch(0.08_0.01_250)] py-10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="flex flex-col items-start gap-8 border-b border-white/10 pb-8 sm:flex-row sm:justify-between">
            <Image src="/images/kosres_logo_refined.png" alt="KOSRES LTD" width={140} height={90} className="h-14 w-auto object-cover" />
