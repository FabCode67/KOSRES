...
import {
  ShieldCheck, TrendingUp, Home, LayoutGrid,
...
const services = [
  ...
  { icon: LayoutGrid,    title: "Other Services",               href: "/services/other",               desc: "Architectural design, construction, quantity surveying, land surveying and environmental impact assessment." },
]
...
const whyChooseUs = [
  { icon: Heart,    title: "Deeply committed to your goals",        desc: "We are deeply committed to our client goals — your success is our success, and we go the extra mile to deliver results that matter." },
  { icon: Award,    title: "Affiliated with leading institutions",   desc: "We are affiliated with real estate institutions, ensuring our services meet the highest professional and regulatory standards." },
  { icon: Trophy,   title: "Leading real estate experts in Kigali", desc: "We are the leading real estate expert in Kigali, with unmatched market knowledge and a proven track record across Rwanda." },
  { icon: Sparkles, title: "Excellent, reliable & wow service",     desc: "We provide excellent, reliable and wow service to our valued customers — every interaction is designed to exceed your expectations." },
]
    ...
    <>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {services.map(({ icon: Icon, title, href, desc }) => (
              <Link key={title} href={href} className="card-hover group flex flex-col gap-3 rounded-xl border border-border bg-white p-5">
                <div className="flex h-11 w-11 items-center justify-center rounded-lg bg-[oklch(0.97_0.03_25)] transition-colors group-hover:bg-[oklch(0.42_0.19_25)]">
                  <Icon size={20} className="text-[oklch(0.42_0.19_25)] transition-colors group-hover:text-white" />
                </div>
                <h3 className="text-sm leading-snug font-bold transition-colors group-hover:text-[oklch(0.42_0.19_25)]">{title}</h3>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6">
        <div className="mb-10 flex items-end justify-between">
          <div>
            ...
            <p className="mt-1 max-w-md text-sm text-muted-foreground">Market reports, investment guides and real estate news from our experts.</p>
          </div>
          <Link href="/publications" className="hidden items-center gap-1 text-sm font-semibold text-[oklch(0.42_0.19_25)] hover:underline sm:inline-flex">
            View all <ChevronRight size={16} />
          </Link>
        </div>
        <PublicationsPreview />
      ...
      <section id="about" className="bg-[oklch(0.97_0.005_80)] py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                <div className="rounded-xl border border-border bg-white p-4">
                  <p className="mb-1 text-xs font-bold tracking-wider text-[oklch(0.42_0.19_25)] uppercase">Vision</p>
                  <p className="text-xs leading-relaxed text-muted-foreground">To be one of the best real estate service providers across Africa.</p>
                </div>
                <div className="rounded-xl border border-border bg-white p-4">
                  <p className="mb-1 text-xs font-bold tracking-wider text-[oklch(0.42_0.19_25)] uppercase">Mission</p>
                  <p className="text-xs leading-relaxed text-muted-foreground">Reliable, innovative real estate services powered by technology to achieve customers' financial goals.</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div>
            <p className="mb-8 text-center text-sm font-semibold tracking-widest text-[oklch(0.42_0.19_25)] uppercase">What sets us apart</p>
            <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
              {whyChooseUs.map(({ icon: Icon, title, desc }) => (
                <div key={title} className="group rounded-2xl border border-border bg-white p-6 shadow-sm transition-shadow hover:shadow-md">
                  ...
                  <h3 className="mb-2 text-sm leading-snug font-black text-slate-800">{title}</h3>
                  <p className="text-xs leading-relaxed text-muted-foreground">{desc}</p>
                </div>
              ))}
            </div>
            <div className="mt-10 flex flex-wrap justify-center gap-3">
              {["Accountability","Reliability","Honesty","Client-Focused","Excellence","Integrity"].map(v => (
                <span key={v} className="flex items-center gap-2 rounded-full border border-[oklch(0.42_0.19_25)]/20 bg-[oklch(0.42_0.19_25)]/8 px-4 py-2 text-sm font-semibold text-[oklch(0.42_0.19_25)]">
                  <span className="h-1.5 w-1.5 flex-none rounded-full bg-[oklch(0.42_0.19_25)]" />{v}
                </span>
              ))}
            </div>
          </div>
      ...
      <section className="border-t border-border bg-[oklch(0.97_0.005_80)] py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="mb-10 text-center">
            <p className="mb-2 text-sm font-semibold tracking-widest text-[oklch(0.42_0.19_25)] uppercase">Trusted Partners</p>
            <h2 className="text-3xl font-black text-slate-800">Our Partners</h2>
            <p className="mx-auto mt-2 max-w-md text-sm text-muted-foreground">
              We collaborate with leading financial and institutional partners to deliver the best real estate solutions to our clients.
            </p>
          </div>
          <PartnersSection />
        </div>
      ...
      <section className="bg-white py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="mb-10 text-center">
            <p className="mb-2 text-sm font-semibold tracking-widest text-[oklch(0.42_0.19_25)] uppercase">Follow Us</p>
            <h2 className="text-3xl font-black text-slate-800">Stay Connected</h2>
            <p className="mx-auto mt-2 max-w-md text-sm text-muted-foreground">
              Follow KOSRES LTD on social media for the latest property listings, market insights and real estate news.
            </p>
          </div>
          <div className="mx-auto grid max-w-5xl grid-cols-2 gap-4 sm:grid-cols-3 lg:grid-cols-5">
            {/* WhatsApp */}
            <a href="https://wa.me/250792871729" target="_blank" rel="noopener noreferrer"
              className="group flex flex-col items-center gap-3 rounded-2xl border-2 border-transparent p-6 transition-all duration-300 hover:-translate-y-1 hover:border-[#25D366] hover:shadow-lg"
              style={{ backgroundColor: "#f0fdf4" }}>
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl shadow-md transition-transform duration-300 group-hover:scale-110" style={{ backgroundColor: "#25D366" }}>
              ...
              <div className="text-center">
                ...
                <p className="mt-0.5 text-xs text-slate-500">+250 792 871 729</p>
                <p className="mt-1.5 text-xs font-semibold" style={{ color: "#25D366" }}>Chat with us →</p>
              </div>
            </a>
            {/* Instagram */}
            <a href="https://instagram.com/kosresltd" target="_blank" rel="noopener noreferrer"
              className="group flex flex-col items-center gap-3 rounded-2xl border-2 border-transparent p-6 transition-all duration-300 hover:-translate-y-1 hover:border-[#E1306C] hover:shadow-lg"
              style={{ backgroundColor: "#fff0f5" }}>
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl shadow-md transition-transform duration-300 group-hover:scale-110"
              ...
              <div className="text-center">
                ...
                <p className="mt-0.5 text-xs text-slate-500">@kosresltd</p>
                <p className="mt-1.5 text-xs font-semibold" style={{ color: "#E1306C" }}>Follow us →</p>
              </div>
            </a>
            {/* Facebook */}
            <a href="https://facebook.com/kosresltd" target="_blank" rel="noopener noreferrer"
              className="group flex flex-col items-center gap-3 rounded-2xl border-2 border-transparent p-6 transition-all duration-300 hover:-translate-y-1 hover:border-[#1877F2] hover:shadow-lg"
              style={{ backgroundColor: "#eff6ff" }}>
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl shadow-md transition-transform duration-300 group-hover:scale-110" style={{ backgroundColor: "#1877F2" }}>
              ...
              <div className="text-center">
                ...
                <p className="mt-0.5 text-xs text-slate-500">KOSRES LTD</p>
                <p className="mt-1.5 text-xs font-semibold" style={{ color: "#1877F2" }}>Like our page →</p>
              </div>
            </a>
            {/* TikTok */}
            <a href="https://tiktok.com/@kosresltd" target="_blank" rel="noopener noreferrer"
              className="group flex flex-col items-center gap-3 rounded-2xl border-2 border-transparent p-6 transition-all duration-300 hover:-translate-y-1 hover:border-[#010101] hover:shadow-lg"
              style={{ backgroundColor: "#f8f8f8" }}>
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl shadow-md transition-transform duration-300 group-hover:scale-110" style={{ backgroundColor: "#010101" }}>
              ...
              <div className="text-center">
                ...
                <p className="mt-0.5 text-xs text-slate-500">@kosresltd</p>
                <p className="mt-1.5 text-xs font-semibold text-slate-700">Follow us →</p>
              </div>
            </a>
            {/* YouTube */}
            <a href="https://youtube.com/@kosresltd" target="_blank" rel="noopener noreferrer"
              className="group flex flex-col items-center gap-3 rounded-2xl border-2 border-transparent p-6 transition-all duration-300 hover:-translate-y-1 hover:border-[#FF0000] hover:shadow-lg"
              style={{ backgroundColor: "#fff5f5" }}>
              <div className="flex h-14 w-14 items-center justify-center rounded-2xl shadow-md transition-transform duration-300 group-hover:scale-110" style={{ backgroundColor: "#FF0000" }}>
                <svg width="26" height="26" viewBox="0 0 24 24" fill="white"><path d="M23.498 6.186a3.016 3.016 0 00-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 00.502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 002.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 002.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
              </div>
              <div className="text-center">
                <p className="text-sm font-bold text-slate-800">YouTube</p>
                <p className="mt-0.5 text-xs text-slate-500">@kosresltd</p>
                <p className="mt-1.5 text-xs font-semibold" style={{ color: "#FF0000" }}>Subscribe →</p>
              </div>
            </a>
          </div>
        </div>
      ...
      <section id="contact" className="bg-[oklch(0.12_0.01_250)] py-20 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          <div className="grid gap-5 text-center sm:grid-cols-2 lg:grid-cols-4">
            ...
            <a href="https://maps.google.com/?q=Beatitude+House+Hotel+Okapi+KN87+Street+Kigali"
              target="_blank" rel="noopener noreferrer"
              className="flex flex-col items-center gap-3 rounded-2xl border border-white/20 bg-white/10 p-7 transition-colors hover:bg-white/20">
              <MapPin size={28} /><p className="font-bold">Visit Our Office</p>
              <div className="space-y-0.5">
                <p className="text-sm font-bold text-amber-300">BEATITUDE HOUSE</p>
                ...
                <p className="mt-1.5 text-[11px] font-semibold text-amber-300/80">Get directions →</p>
              </div>
            </a>
      ...
      <footer className="bg-[oklch(0.08_0.01_250)] py-10">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="flex flex-col items-start gap-8 border-b border-white/10 pb-8 sm:flex-row sm:justify-between">
            <Image src="/images/kosres_logo_refined.png" alt="KOSRES LTD" width={140} height={90} className="h-14 w-auto object-contain" />
