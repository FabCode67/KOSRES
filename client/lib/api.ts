// API base URL — Next.js server components use the full URL; client components use relative via proxy
...
// ── Admin CRUD ──
export async function createProperty(data: Partial<ApiProperty>, token: string) {
...
export async function updateProperty(id: string, data: Partial<ApiProperty>, token: string) {
